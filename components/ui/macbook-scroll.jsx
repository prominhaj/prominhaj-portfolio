...
import IframeEmbed from "../globals/IframeEmbed/IframeEmbed";
    ...
    return (
        (<div
            ...
            <Lid
                ...
                scaleY={scaleY}
                rotate={rotate}
                translate={translate}>{children}</Lid>
            {/* Base area */}
            <div
                ...
                {showGradient && (
                    <div
                        className="absolute inset-x-0 bottom-0 z-50 w-full h-40 bg-gradient-to-t dark:from-black from-white via-white dark:via-black to-transparent"></div>
                )}
    ...
    return (
        (<div className="relative [perspective:800px]">
            ...
            <motion.div
                ...
                className="h-[500px] w-full absolute inset-0 bg-[#010101] rounded-2xl p-2">
                {children}
            </motion.div>
        </div>)
    );
